...
package roc.gtw.handler.spring;
 ...
 */
public abstract class SpringAbstractHandlerMethodMapping<T> extends AbstractHandlerMapping implements InitializingBean {
	...
	protected CorsConfiguration getCorsConfiguration(Object handler, HttpServletRequest request) {
		...
		if (handler instanceof HandlerMethod handlerMethod) {
			if (handlerMethod.equals(PREFLIGHT_AMBIGUOUS_MATCH)) {
				return SpringAbstractHandlerMethodMapping.ALLOW_CORS_CONFIG;
			}
			else {
	...
	class MappingRegistry {
		...
		public void register(T mapping, Object handler, Method method) {
			...
			try {
				...
				Set<String> directPaths = SpringAbstractHandlerMethodMapping.this.getDirectPaths(mapping);
