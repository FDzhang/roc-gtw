 ...
 * @since 3.1
 */
public abstract class SpringRequestMappingInfoHandlerMapping extends SpringAbstractHandlerMethodMapping<RequestMappingInfo> {
	...
	protected SpringRequestMappingInfoHandlerMapping() {
